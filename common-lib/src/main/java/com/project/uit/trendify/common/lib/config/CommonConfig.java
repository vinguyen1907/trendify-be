...
@EnableJpaRepositories(basePackages = "com.project.uit.trendify.common.lib.repository")
@EntityScan(basePackages = "com.project.uit.trendify.common.lib.entity")
@ComponentScan("com.project.uit.trendify.common.lib")
